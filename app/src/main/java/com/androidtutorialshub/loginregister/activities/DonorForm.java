...
import static com.androidtutorialshub.loginregister.activities.MainScreen.database;
...
public class DonorForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] citis = new String[]{"Bangalore","Chennai", "Delhi", "Hyderabad","Jaipur", "Raipur", "Mangalore", "Shimla"};
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lat = MainScreen.lat.toString();
                String lng = MainScreen.lng.toString();
